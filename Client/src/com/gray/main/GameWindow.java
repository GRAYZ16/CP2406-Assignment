...
public class GameWindow extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		double rectX = Main.player.getPos().getX() +  Util.TILE_SIZE * Main.player.getVecDir().getX();

		double rectY = Main.player.getPos().getY() +  Util.TILE_SIZE * Main.player.getVecDir().getY();

		double width = Util.TILE_SIZE + Math.abs(Main.player.getVecDir().getX()) * Util.TILE_SIZE;
		double height = Util.TILE_SIZE + Math.abs(Main.player.getVecDir().getY()) * Util.TILE_SIZE;
